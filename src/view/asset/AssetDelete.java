 ...
 * @author pedro
 */
public class AssetDelete extends javax.swing.JFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if(AssetController.delete(Long.valueOf(idComboBox.getSelectedItem().toString()))){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssetDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
